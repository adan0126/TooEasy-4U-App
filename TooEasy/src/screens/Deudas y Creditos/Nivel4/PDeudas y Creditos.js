...
// 🛑 Componente renombrado a PDeudasyCreditos4Screen
export default function PDeudasyCreditos4Screen({ navigation }) {
  // ----------------------------------------------------------
  // ARRAY DE PREGUNTAS (ACTUALIZADO CON INFO DE DEUDAS BUENAS VS MALAS)
  // ----------------------------------------------------------
  const preguntas = [
    {
      id: "1",
      ...
      opciones: [
        "Comprar ropa con tarjeta sin necesitarla.",
        "Un crédito para estudiar una carrera.",
        "Usar crédito para pagar otra deuda más cara."
      ],
      correcta: mapRespuestaCorrecta("B"), // 1
    },
    {
      id: "2",
      pregunta: "Las deudas malas se adquieren por impulso o sin planificación. Verdadero o falso:",
      opciones: [
        "Verdadero",
        "Falso"
      ],
    ...
    {
      id: "3",
      pregunta: "Una deuda buena debe:",
      opciones: [
        "Generar valor o mejorar tu situación financiera.",
        "Aumentar tus gastos sin beneficio.",
        "Tener intereses muy altos."
      ],
      correcta: mapRespuestaCorrecta("A"), // 0
    },
    {
      id: "4",
      pregunta: "¿Qué práctica te ayuda a evitar las deudas malas?",
      opciones: [
        "Comprar sin comparar precios.",
        "Gastar más de lo que ganas.",
        "Planificar antes de usar crédito."
      ],
      correcta: mapRespuestaCorrecta("C"), // 2
    },
    {
      id: "5",
      pregunta: "Una deuda mala normalmente se usa para:",
      opciones: [
        "Invertir en tu educación.",
        "Gastos innecesarios o impulsivos.",
        "Adquirir bienes que aumentan de valor."
      ],
      correcta: mapRespuestaCorrecta("B"), // 1
    }
  ];
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Preguntas de Repaso (4/4)</Text>
